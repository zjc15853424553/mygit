            ...
            <div className='navbox'>
                <div className='nav'>
                    <div className='navLeft'>
                        <ul>
                            <li onClick={this.myName.bind(this)}><a  href="#"><img src={require('../assest/nav01.jpg')} alt=""/></a></li>
                ...
                <div ref='thediv' className='myLeft'>
                    <div className='indexNav'>
                        ...
                        <div className='navBot'>
                            <ul>
                                <li onClick={this.collect.bind(this)}><a href="#"><img src={require('../assest/navleft01.jpg')} alt=""/></a></li>
        ...
        window.addEventListener("scroll", function () {
            ...
            if(document.body.scrollHeight <= window.screen.height + document.documentElement.scrollTop){
                console.log('进来了，走这段代码了');
                 setTimeout(()=>{
                    axios.get('https://news-at.zhihu.com/api/4/news/before/'+_this.state.time).then((res)=>{
                        console.log(res)
                        _this.setState({
                            time:res.data.date,
