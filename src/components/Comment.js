...
class Comment extends React.Component {
    ...
    componentWillMount() {
        axios.get('https://news-at.zhihu.com/api/4/story/' + this.props.location.state.id + '/short-comments').then((res) => {
            console.log(res)
            this.setState({
                arr: res.data.comments
            })
        })
        axios.get('https://news-at.zhihu.com/api/4/story/'+this.props.location.state.id+'/long-comments').then((res)=>{
            console.log(res)
